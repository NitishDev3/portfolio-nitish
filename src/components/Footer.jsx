...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="bg-gradient-to-br w-full from-gray-800 to-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="home" className="text-gray-400 hover:text-blue-500 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="projects" className="text-gray-400 hover:text-blue-500 transition-colors">
                  Projects
                </Link>
              </li>
              <li>
          ...
          >
            ...
            <div className="mt-4 flex justify-center md:justify-end space-x-4">
              ...
              {/* LinkedIn SVG */}
              <a
                href="https://www.linkedin.com/in/nitish-kumar-sahu-39849b157/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* GitHub SVG */}
              <a
                href="https://github.com/NitishDev3"
                target="_blank"
                rel="noopener noreferrer"
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} Nitish.D∃V. All rights reserved.
          </p>
        </motion.div>
      </div>
    </motion.footer>
